...
const CartPage = () => {
  ...
  return (
    <Layout>
      <div className="max-w-3xl mx-auto mt-20 p-6 bg-gray-100 rounded-lg shadow-lg">
        ...
        <div className="text-center mt-6">
          <a href="/UserHomePage/Home" className="bg-pink-700 text-white px-4 py-2 rounded inline-block">Back</a>
        </div>
      </div>
